...
const loadOrderComplete = async (req, res) => {
    try {
        ...
        if (!user_id) {
            ...
            async function createOrderFromCart(cartData, pdfFilePath) {
                try {
                    console.log('Received pdfFilePath:', pdfFilePath)
            ...
            var pdfFilePath = path.join(invoicesFolderPath, pdfFileName)
